...
export const useStore = defineStore('store', {
  ...
  actions: {
    ...
    // async changeCount(e: { target: { value: any } }, product: Product) {
    //   const v = e.target.value
    //   const re = 1 + +v > 1
    //   const re2 = product.totalCountproduct - v >= 0
    //   if (re && re2) {
    //     product.countInCart = v
    //     product.totalCountproduct = product.totalCountproduct - v
    //   }
    // },
  },
})
